...
#define NMEA_MAX_STATEMENT_ITEM_LENGTH (64)
#define NMEA_EVENT_LOOP_QUEUE_SIZE (64)
...
nmea_parser_handle_t nmea_parser_init(const nmea_parser_config_t *config)
{
    ...
    char * data = "$PMTK225,1,0,10000,0,0";
    uart_write_bytes(esp_gps->uart_port, data, strlen(data));
    return esp_gps;
    /*Error Handling*/
err_task_create:
